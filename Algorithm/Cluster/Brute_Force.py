...
# class Brute_Force_Cluster:
#     def __init__(self):
#         print("Thuật toán Brute_Force TSP")

#     def brute_force_tsp(self,points, distance_matrix, start_point, on, off):
...
#     def total_distance(self, route, distance_matrix, on, off):
#         total = 0
#         if on == True:
...
#             route = (start_index,) + route  # Thêm điểm xuất phát vào đầu lộ trình
#             distance = self.total_distance(route, distance_matrix)
...
class Brute_Force_Cluster:
    ...
    def brute_force_tsp(points, distance_matrix, start_point, on, off):
        ...
        shortest_distance = float("inf")
        shortest_route = None
        # Liệt kê tất cả các hoán vị của các điểm (trừ điểm xuất phát)
        all_routes = list(
            itertools.permutations([i for i in range(len(points)) if i != start_index])
        )
        for route in all_routes:
...
#     [20.851344033982606, 104.70464633175901],
#     [20.423718223531758, 106.15880282612936],
#     [20.916538519892267, 106.10661156142478],
#     [15.858457723278487, 108.38838887981179],
...
#     [13.987031486263923, 107.99237541447324],
...
#     [10.819410113629296, 106.70194892514708],
#     [10.78085784198798, 106.63160549815758],
#     [10.745645409601028, 106.73286228068469],
#     [10.77113588566068, 106.69506125398182],
...
#     ],
# ]
# Brute_Force_Cluster.brute_force_tsp(point, distance, point[0], False, True)
